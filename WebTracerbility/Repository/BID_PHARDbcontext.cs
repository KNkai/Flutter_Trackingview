...
namespace BidPhar_services.Repository
{
    public partial class BID_PHARDbcontext : DbContext
    {
        public BID_PHARDbcontext()
        {
        }

        public BID_PHARDbcontext(DbContextOptions<BID_PHARDbcontext> options)
            : base(options)
        {
        }
