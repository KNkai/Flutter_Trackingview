                    ...
                    funcButton1: (){
                      if(_typeEmploy==1 || _typeEmploy==2){
                        ...
                        ProductTransactions productTransactions = new ProductTransactions(
                          ...
                          dateChecked: DateTime.now().toString().substring(0,10),
                        ...
                        Products data = new Products(
                          id: this._idController.text, 
                          manufacturedDate: this._mgfDateController.toString(), 
                          expiredDate: this._expDateController.toString(),
                          manufactured: this._nameManufacController.text,
                          nameProduct: this._nameProductController.text,
                          details: this._detailController.text,
                        );
                        //add 
                        print(isUpdate);
                        if(isUpdate==false){
